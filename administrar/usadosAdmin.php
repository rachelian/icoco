...
<body>
	...
	<nav class="navbar navbar-expand-lg fixed-top">
	  ...
	  <div class="collapse navbar-collapse" id="navbarText">
	    <ul class="nav nav-pills mr-auto">
	      ...
	      <li class="nav-item">
	        <a class="nav-link active" href="usadosAdmin.php">Usados</a>
	      </li>
	      <li class="nav-item">
	...
	<section class="margen">
		<div class="container">
			<header>
				<h1 class="text-center">Productos Usados</h1>
			</header>
			<hr>
			<div class="row">
					...
					<form action="../php/buscar.php" method="POST">
						<div class="input-group">
							...
							<div class="input-group-append">
								<button class="btn btn-info" type="submit" name="bus_usado">Buscar</button>
							</div>
						</div>
					</form>
				</div>
				...
				<div class="table-responsive">
					<table class="table table-hover table-bordered table-sm">
						<tr class="thead-dark">
							...
							<th>Costo</th>
							<th>Foto</th>
							<th colspan="2">Edi/Eli</th>
						</tr>
						<?php
						$sqlmostrar = "select * from producto where pro_marca = 'Usado';";//colocar el where para usados
						...
						while ($fila = mysqli_fetch_array($resultado)) {
							echo '<tr>
									...
									<td>'.$fila['pro_foto'].'</td>
									<form action="../php/editar_usado.php" method="POST">
										<td><button type="submit" value="'.$fila['pro_codigo'].'" class="btn btn-warning btn-sm" name="botonEditar"><i class="fas fa-pencil-alt"></i></button></td>
										<td><button type="submit" value="'.$fila['pro_codigo'].'" class="btn btn-danger btn-sm boton-tabla" name="botonEliminar"><i class="far fa-trash-alt"></i></button></td>
									</form>
								</tr>';
						}
						?>
	      ...
	      <form action="../php/agregar_productos.php" method="POST" enctype="multipart/form-data">
		      <div class="modal-body">
		        ...
		        <div class="form-group">
		        	...
		        	<input type="text" class="form-control" value="Usado" name="marca" id="marca" onblur="validarTexto(this)" onkeyup="validarTexto(this)" readonly>
		        </div>
		        <div class="form-group">
